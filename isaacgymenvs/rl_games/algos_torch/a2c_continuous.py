...
class A2CMultiAgent(a2c_common.ContinuousMultiA2CBase):
    ...
    def calc_gradients_left(self, input_dict):
        value_preds_batch = input_dict['old_values']
        old_action_log_probs_batch = input_dict['old_logp_actions']
        advantage = input_dict['advantages']
        old_mu_batch = input_dict['mu']
    ...
    def calc_gradients_right(self, input_dict):
        value_preds_batch = input_dict['old_values']
        old_action_log_probs_batch = input_dict['old_logp_actions']
        advantage = input_dict['advantages']
        old_mu_batch = input_dict['mu']
    ...
    def train_actor_critic_multi(self, input_dict_left):
        self.calc_gradients_left(input_dict_left)


        return self.train_result_left
